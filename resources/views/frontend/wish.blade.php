...
<body class="js">
				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="{{ route('wish.page') }}">Wish</a></li>
						</ul>
					</div>
				</div>
			</div>
	...
	<!-- End Breadcrumbs -->
            <h1 class="text-center">Your favorites products</h1><hr>
	<!-- Shopping Cart -->
...
<tr>
								<td class="image" data-title="No"><img src="{{ asset($wish->image) }}" alt="#"></td>
								<td class="product-des" data-title="Description">
									<p class="product-name"><a href="{{ route('main.show' , $wish->product_id) }}">{{ $wish->name }}</a></p>

								</td>
								<td class="price" data-title="Price"><span><del>{{ $wish->oldprice }}</del></span>
                                         <span>{{ ($wish->oldprice - ( $wish->oldprice * ($wish->product->discount / 100  )))  }}</span>
                                      </td>



								<td class="action" data-title="Remove"><a href="{{ route( 'delete.wish' , $wish->id )}}"><i class="ti-trash remove-icon"></i></a></td>
