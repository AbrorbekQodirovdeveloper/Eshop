										...
										<div class="nav-inner">
											<ul class="nav main-menu menu navbar-nav">
													...
													<li class="active"><a href="">Shop<i class="ti-angle-down"></i><span class="new">New</span></a>
														<ul class="dropdown">
															<li class="active"><a href="{{ route('cart.page') }}">Cart</a></li>
...
<tr>
								...
								<td class="product-des" data-title="Description">
									<p class="product-name"><a href="{{ route('main.show' , $cart->product_id) }}">{{ $cart->name }}</a></p>

								</td>
								<td class="price" data-title="Price"><span><del>{{ $cart->oldprice }}</del></span>
                                         <span>{{ ($cart->oldprice - ( $cart->oldprice * ($cart->discount / 100  )))  }}</span>
                                      </td>
                                            <td class="image"><div class="" style="background-color: {{ $cart->color->color }} ; height: 30px; width:30px;"  >
                                                      </div></td>
                                            <td class="image"><div>{{ $cart->size->size }}</div></td>
								<td class="qty" data-title="Qty"><!-- Input Order -->
									<div class="input-group">
										...
										<input type="text" name="quant[1]" class="input-number"  data-min="1" data-max="100" value="{{ $cart->count }}" readonly>
								...
								<td class="total-amount" data-title="Total"><span>{{ ($cart->oldprice - ( $cart->oldprice * ($cart->discount / 100  ))) *  $cart->count }}</span></td>
								<td class="action" data-title="Remove"><a href="{{ route( 'delete.cart' , $cart->id )}}"><i class="ti-trash remove-icon"></i></a></td>
								<td class="action" data-title="Remove"><a href="{{ route('main.show' , $cart->product_id) }}"><i class="ti-eye remove-icon"></i></a></td>
							</tr>
                           @endforeach
