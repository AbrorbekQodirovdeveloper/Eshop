...
<body class="js">
									...
									<div class="navbar-collapse">
										<div class="nav-inner">
											<ul class="nav main-menu menu navbar-nav">
													...
													<li class="active"><a href="{{ route('order.page') }}">My orders</a></li>
	...
	<!--/ End Header -->
     ...
     <div class="cart-area pt-100 pb-100 mt-5">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        @foreach ($orders as $order)
                            <div>
                                <div class="alert alert-info" role="alert" data-toggle="collapse"
                                    ...
                                    <p class="p-0 m-0">Buyurtma qiymati: <b>{{ $order->total_sum }}  </b></p>
                                </div>
                                        ...
                                        <div class="card card-body mb-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="p-0 m-0">Narxi: <b>{{ $product->price }}</b></p>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
