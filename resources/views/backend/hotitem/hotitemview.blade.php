      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header d-flex justify-content-end">
            <a href="{{ route('hotitem.add') }}" class="btn btn-primary float-right">Add to hotitem </a>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
              ...
              <tbody>
                @foreach ($hotitems as $item )
                  <tr>
                    ...
                    <td width="12%">
                      <a href="{{ route('hotitem.edit' , $item->id) }}" class="btn btn-info" title="Edit"><i class="fas fa-edit"></i></a>
                      <a href="{{ route('hotitem.delete' , $item->id) }}" class="btn btn-danger" title="Delete" id="delete"><i class="fas fa-trash"></i></a>
                    </td>
                  </tr>
                @endforeach
              </tbody>
