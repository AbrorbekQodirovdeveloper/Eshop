    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <form action="{{ route('productimage.store') }}" method="POST"  enctype="multipart/form-data" class="col-12 mt-5">
                       @csrf

               <div class="container">
                 <center>
                 <h1>Product image crete</h1>
                 </center><br><br>
                  ...
                  <input type="number" class="form-control" name="product_id" placeholder="Your product image site product_id"><br>
                @error('product_id')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
