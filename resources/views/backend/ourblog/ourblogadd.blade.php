    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                 ...
                 <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('all.ourblog') }}" class="nav-item nav-link active "><i class="fa fa-chart-bar me-2"></i>Ourblog</a>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <form action="{{ route('ourblog.store') }}" method="POST"  enctype="multipart/form-data" class="col-12 mt-5">
                       @csrf

               <div class="container">
                 <center>
                 <h1>Our blog crete</h1>
                 </center><br><br>
