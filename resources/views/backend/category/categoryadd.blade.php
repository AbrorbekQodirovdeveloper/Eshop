...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <form action="{{ route('category.store') }}" method="POST" class="col-12 mt-5">
                       @csrf

               <div class="container">
                 <center>
                 <h1>Category crete</h1>
                 </center><br><br>
    ...
    <div class="col-10">
                  ...
                  <input type="number" class="form-control" name="partner_id" placeholder="Your category partner_id"><br>
                @error('partner_id')
                   <span class="text-danger">{{ $message }}</span>
                     @enderror
                  <input type="text" class="form-control" name="name" placeholder="Your category name" ><br>
                       @error('name')
                         <span class="text-danger">{{ $message }}</span>
                     @enderror
