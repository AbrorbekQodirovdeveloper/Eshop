        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
               ...
               <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('all.category') }}" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Category</a>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header d-flex justify-content-end">
            <a href="{{ route('category.add') }}" class="btn btn-primary float-right">Add to category </a>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
              ...
              <tbody>
                @foreach ($category as $item)
                  <tr>
                    ...
                    <td>{{ $item->name }}</td>
                    <td width="12%">
                      <a href="{{ route('category.edit' , $item->id) }}" class="btn btn-info" title="Edit"><i class="fas fa-edit"></i></a>
                      <a href="{{ route('category.delete' , $item->id) }}" class="btn btn-danger" title="Delete" id="delete"><i class="fas fa-trash"></i></a>
                    </td>
                  </tr>
                @endforeach
              </tbody>
