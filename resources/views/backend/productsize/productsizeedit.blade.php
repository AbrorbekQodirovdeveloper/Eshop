    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            ...
            <div class="bg-success rounded-circle border border-2 border-white position-absolute end-0 bottom-0 p-1"></div>
             ...
             <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('all.productsize') }}" class="nav-item nav-link active "><i class="fa fa-chart-bar me-2"></i>Product size</a>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <form action="{{ route('productsize.update' , $productsizes->id) }}" method="POST" enctype="multipart/form-data" class="col-12 mt-5">
                       @csrf
         ...
         <div class="row">
     <div class="col-10">
                  <input type="text" class="form-control" name="size" placeholder="Your product color site size" value="{{ $productsizes->size }}"><br>
                @error('size')
