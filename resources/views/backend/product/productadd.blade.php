...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <form action="{{ route('product.store') }}" method="POST"  enctype="multipart/form-data" class="col-12 mt-5">
                       @csrf
    ...
    <div class="col-10">
                ...
                <input type="number" class="form-control" name="category_id" placeholder="Your product site category id"><br>
                @error('category_id')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
                  <input type="text" class="form-control" name="name" placeholder="Your product site name"><br>
                @error('name')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
               <input type="number" class="form-control" name="price" placeholder="Your product site price"><br>
                @error('price')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
                 <input type="number" class="form-control" name="oldprice" placeholder="Your product site oldprice"><br>
                @error('oldprice')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
                <input type="number" class="form-control" name="discount" placeholder="Your product site discount"><br>
                @error('discount')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
             <input type="text" class="form-control" name="title" placeholder="Your product site title"><br>
                @error('title')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
                <input type="text" class="form-control" name="about" placeholder="Your product site about"><br>
                @error('about')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
               <input type="text" class="form-control" name="type" placeholder="Your product site tpe"><br>
                @error('type')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
