    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            ...
            <div class="bg-success rounded-circle border border-2 border-white position-absolute end-0 bottom-0 p-1"></div>
                 ...
                 <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('all.offer') }}" class="nav-item nav-link active"><i class="fa fa-laptop me-2"></i>Offer</a>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <form action="{{ route('offer.update' , $offers->id) }}" method="POST" class="col-12 mt-5" enctype="multipart/form-data">
                       @csrf
   ...
   <div class="col-10">
                                       ...
                                       <div class="col-md-12 ">
                                        <div class="form-group">
                                            <label for="exampleFormControlFile1">Bg_Image</label>
                  ...
                  <input type="text" class="form-control" name="bg_name" placeholder="Your offer bg_name"  value="{{ $offers->bg_name }}"><br>
                @error('bg_name')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
                  <input type="text" class="form-control" name="bg_title" placeholder="Your offer bg_title" value="{{ $offers->bg_title }}"><br>
                @error('bg_title')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
               <input type="text" class="form-control" name="bg_about" placeholder="Your offer bg_about"  value="{{ $offers->bg_about }}"><br>
                @error('bg_about')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
                <input type="text" class="form-control" name="title" placeholder="Your offer title"  value="{{ $offers->title }}"><br>
                @error('title')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
             <input type="text" class="form-control" name="about" placeholder="Your offer about"  value="{{ $offers->about }}"><br>
                @error('about')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
