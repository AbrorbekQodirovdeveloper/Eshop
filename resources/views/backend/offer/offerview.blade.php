      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header d-flex justify-content-end">
            ...
            <a href="{{ route('offer.add') }}" class="btn btn-primary float-right">Add to offer </a>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
              ...
              <tbody>
                @foreach ($offers as $item)
                  <tr>
                    ...
                    <td width="12%">
                      <a href="{{ route('offer.edit' , $item->id) }}" class="btn btn-info" title="Edit"><i class="fas fa-edit"></i></a>
                      <a href="{{ route('offer.delete' , $item->id) }}" class="btn btn-danger" title="Delete" id="delete"><i class="fas fa-trash"></i></a>
                    </td>
                  </tr>
                @endforeach
              </tbody>
