...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <form action="{{ route('offer.store') }}" method="POST"  enctype="multipart/form-data" class="col-12 mt-5">
                       @csrf
    ...
    <div class="col-10">
                  ...
                  <input type="text" class="form-control" name="bg_name" placeholder="Your offer bg_name"><br>
                @error('bg_name')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
                  <input type="text" class="form-control" name="bg_title" placeholder="Your offer bg_title"><br>
                @error('bg_title')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
               <input type="text" class="form-control" name="bg_about" placeholder="Your offer bg_about"><br>
                @error('bg_about')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
                <input type="text" class="form-control" name="title" placeholder="Your offer title"><br>
                @error('title')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
             <input type="text" class="form-control" name="about" placeholder="Your offer about"><br>
                @error('about')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
