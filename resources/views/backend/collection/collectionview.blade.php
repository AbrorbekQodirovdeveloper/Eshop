      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header d-flex justify-content-end">
            <a href="{{ route('collection.add') }}" class="btn btn-primary float-right">Add to collection </a>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
              ...
              <tbody>
                @foreach ($collections as $item)
                  <tr>
                    ...
                    <td width="12%">
                      <a href="{{ route('collection.edit' , $item->id) }}" class="btn btn-info" title="Edit"><i class="fas fa-edit"></i></a>
                      <a href="{{ route('collection.delete' , $item->id) }}" class="btn btn-danger" title="Delete" id="delete"><i class="fas fa-trash"></i></a>
                    </td>
                  </tr>
                @endforeach
              </tbody>
