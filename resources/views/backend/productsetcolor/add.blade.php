    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <form action="{{ route('productsetcolor.store') }}" method="POST"  enctype="multipart/form-data" class="col-12 mt-5">
                       @csrf

               <div class="container">
                 <center>
                 <h1>Product set color crete</h1>
                 </center><br><br>

                   <div class="row">
                          <div class="col-10">
                  <input type="number" class="form-control" name="product_id" placeholder="Your product set color product id "><br>
                   @error('product_id')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
                    <input type="number" class="form-control" name="color_id" placeholder="Your product set color . color id"><br>
                   @error('color_id')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
