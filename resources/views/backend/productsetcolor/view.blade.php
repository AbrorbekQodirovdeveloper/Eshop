        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
               ...
               <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('all.productsetcolor') }}" class="nav-item nav-link active "><i class="fa fa-chart-bar me-2"></i>ProductSetcolor</a>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header d-flex justify-content-end">
            <a href="{{ route('productsetcolor.add') }}" class="btn btn-primary float-right">Add to product set color </a>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <table id="example" class="table table-bordered table-striped">
              ...
              <tbody>
                @foreach ($productsetcolors as $item)
                  <tr>
                    ...
                    <td width="12%">
                      <a href="{{ route('productsetcolor.edit' , $item->id) }}" class="btn btn-info" title="Edit"><i class="fas fa-edit"></i></a>
                      <a href="{{ route('productsetcolor.delete' , $item->id) }}" class="btn btn-danger" title="Delete" id="delete"><i class="fas fa-trash"></i></a>
                    </td>
                  </tr>
                @endforeach
              </tbody>
