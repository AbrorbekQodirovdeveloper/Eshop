    ...
    <div class="col-10">
               ...
               <input type="text" class="form-control" name="phone" placeholder="Your main phone"><br>
                @error('phone')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
                <input type="text" class="form-control" name="address" placeholder="Your main address"><br>
                @error('adress')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
             <input type="email" class="form-control" name="email" placeholder="Your main email"><br>
                @error('email')
                   <span class="text-danger">{{ $message }}</span>
                    @enderror
